      ...
      items: [
        {
          ...
          imageAlt: 'Una educadora de la Fundación Elva Fonseca dirigiendo una actividad de aprendizaje',
          titleLines: ['Educación y', 'Tecnología'],
          description: 'Apoyo escolar, becas y talleres para un futuro mejor.',
          modalBody: [
            { text: 'Ofrecemos ', strong: false },
            { text: 'clases, actividades educativas y acceso a la tecnología', strong: true },
            {
              text: ' que ayudan a niños, jóvenes, adultos y personas mayores a aprender nuevas habilidades y crear nuevas oportunidades.',
              strong: false,
            },
          ],
        },
        {
          ...
          imageAlt: 'Una integrante de la comunidad recibiendo un examen de la vista',
          titleLines: ['Movilidad y', 'Salud'],
          description: 'Campañas médicas, cuidado y prevención.',
          modalBody: [
            { text: 'Proporcionamos ', strong: false },
            { text: 'sillas de ruedas, andadores, muletas y otros equipos de movilidad', strong: true },
            { text: ' para ayudar a las personas a mantener una mayor independencia. También ofrecemos ', strong: false },
            {
              text: 'campañas de salud visual y dental, exámenes médicos y clases básicas de enfermería y cuidados.',
              strong: true,
            },
          ],
        },
        {
          ...
          titleLines: ['Desarrollo', 'Comunitario'],
          description: 'Talleres y capacitación para fortalecer nuestra comunidad.',
          modalBody: [
            {
              text: 'Conectamos a las familias con recursos comunitarios, orientación legal general, apoyo para la crianza y talleres educativos. Tenemos un compromiso especial con las familias de niños con necesidades especiales, ayudando a los padres a acceder a información, recursos y apoyo comunitario.',
              strong: false,
            },
          ],
        },
        {
          ...
          titleLines: ['Comedor', 'Comunitario'],
          description: 'Programas de nutrición para niños y familias.',
          modalBody: [
            { text: 'Ofrecemos ', strong: false },
            { text: 'desayunos y comidas gratuitas', strong: true },
            {
              text: ' a personas y familias que viven en situación de pobreza y necesidad extrema, con atención especial a ',
              strong: false,
            },
            { text: 'niños y adultos mayores.', strong: true },
          ],
        },
        {
          key: 'art',
          ...
          imageAlt: 'Niños participando en una actividad educativa de arte',
          titleLines: ['Arte, Cultura y', 'Medio Ambiente'],
          description: 'Clases de arte y actividades culturales.',
          modalBody: [
            { text: 'Ofrecemos ', strong: false },
            { text: 'clases de arte, actividades culturales y programas ambientales', strong: true },
            {
              text: ' que fomentan la creatividad, la expresión personal, la conexión comunitaria y la conciencia ambiental. Nuestras actividades están diseñadas para ser inclusivas y recibir a ',
              strong: false,
            },
            { text: 'niños y personas con necesidades especiales.', strong: true },
          ],
        },
      ],
      ...
      categories: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              a: {
                before: 'Puedes contactarnos directamente a través del ',
                linkLabel: 'formulario de contacto en nuestro sitio web',
                after:
                  ' o en nuestras redes sociales para conocer más sobre programas, voluntariado, donaciones o alianzas.',
              },
            },
          ],
        },
